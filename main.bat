...
:enc-chat
echo lulztools/main.bat:enc-chat> ERROR: THIS APPLICATION IS NOT FINISHED
goto end
echo lulztools/main.bat:enc-chat> 1 = Start Host
echo lulztools/main.bat:enc-chat> 2 = Log In
set /p option=lulztools/main.bat:enc-chat> 
if %option% == 1 goto enc-chat_server
if %option% == 2 goto enc-chat_client
goto end
